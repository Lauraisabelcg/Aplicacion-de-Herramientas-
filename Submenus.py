...
from logs import lista_logs
from mensajesuwu import mensajes, lista_mensajes
...
def Submenu_Herramientas():
    while True:
        sub_H_op=ValidarMenu('''
                ...
                6.Consultar mensajes escritos por los usuarios
                             
                7.Consultar errores comunmente cometidos por los usuarios
                             
                8.Regresar al Menu Administrador
                             
                             
                            
                            ''',1,8)
        while sub_H_op==None:
            sub_H_op=ValidarMenu('',1,8)
        match sub_H_op:
            case 1:
                agregar_herramienta()
            case 2:
...
def MenuUsuarios():
    while True:
        opmenu_Usuario=ValidarMenu('''
            ...
            4. Comunicar algo al Administrador
                           
            5. Salir
                           ''',1,5)
    
        while opmenu_Usuario==None:
            opmenu_Usuario=ValidarMenu('',1,5)
